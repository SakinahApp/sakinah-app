...
export default function SignInPhone() {
  ...
  function generateRecaptcha() {
    // We create global variable in our app with window.recaptchaVerifier and this 
    // variable is basically reCAPTCHA form that has been generated
    // if it visible reCAPTCHA user has to fill the form and if it is invisible reCAPTCHA
    // it will just a pop-up in our screen and do verification on the background and the variable that
    // will be referencing this later will be window.recaptchaVerifier
    // 'reCaptcha-container' is the id of the div that will render (display) reCAPTCHA
  ...
  function requestOTP(e) {
    ...
    if (phoneNumber.length >= 12) {
      ...
      // once we generate reCaptcha (line 69), we call signInWithPhoneNumber and pass 3 arguments
      // once resolved, it returns confirmationResult and it sends SMS/OTP to the user 
