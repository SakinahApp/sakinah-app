...
export default function SignUpTherapist() {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    createUserWithEmailAndPassword(authTherapist, email, password)
      .then((userCredential) => {
        // Signed in 
      ...
      .then(() => {
        ...
        setMessage("Email verification sent! Please check your email including SPAM folder. After verified your account, you can log in.");
